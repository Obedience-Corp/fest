...
func FestEntries() []contract.Entry {
	return []contract.Entry{
		...
		// Dungeon subdirectories. Path is the visible spelling; FallbackPaths
		// covers campaigns scaffolded with the hidden .dungeon/ spelling
		// (dungeon_hidden). The daemon tries Path first, then each fallback,
		// which matches fest's own "prefer visible, else hidden" resolution.
		{
			...
			Owner:         contract.OwnerFest,
			Status:        "archived",
			FallbackPaths: []string{"festivals/.dungeon/archived/"},
		},
		{
			...
			Owner:         contract.OwnerFest,
			Status:        "completed",
			FallbackPaths: []string{"festivals/.dungeon/completed/"},
		},
		{
			...
			Owner:         contract.OwnerFest,
			Status:        "someday",
			FallbackPaths: []string{"festivals/.dungeon/someday/"},
		},
